...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'liste-categories',      component: ListCategorieComponent},
    { path: 'liste-categories/add-categorie',      component: AddCategorieComponent},
    { path: 'liste-categories//update-categorie',      component: UpdateCategorieComponent},
